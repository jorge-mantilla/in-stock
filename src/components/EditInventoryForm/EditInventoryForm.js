        ...
        <>
            <section className="inventoryForm">
                <div className="inventoryForm__tablet-header-box">
                    ...
                    <h1 className="inventoryForm__header">Edit Inventory Item</h1>
                </div>
                <div className="inventoryForm__tablet-wrapper">
                    <div className="inventoryForm__tablet-form-box">
                        ...
                        <div className="inventoryForm__whd-container">
                            ...
                            <form className="inventoryForm__wh-form" onSubmit={handleSubmit}>
                                <label className="inventoryForm__label">Item Name
                                </label>
                                <input type="text" name="item_name" placeholder="Item Name" value={inventoryData.item_name} onChange={handleInputChange} className="inventoryForm__input" />

                                <label className="inventoryForm__label">Description
                                </label>
                                <input type="text" name="descriptiom" placeholder="Description" value={inventoryData.description} onChange={handleInputChange} className="inventoryForm__input-description" />

                                <label className="inventoryForm__label">Category</label>
                                <select type="text" name="category" placeholder="Please Select" value={inventoryData.category} onChange={handleInputChange} className="inventoryForm__input">
                                    <option value=""></option>
                                </select>
                            </form>
                        </div>
                    ...
                    <div className="inventoryForm__tablet-form-contact-box">
                        ...
                        <div className="inventoryForm__whd-container">
                            ...
                            <form className="inventoryForm__contact-form" onSubmit={handleSubmit}>
                                ...
                                <input type="text" name="quantity" placeholder="0" value={inventoryData.quantity} onChange={handleInputChange} className="inventoryForm__input" />

                                <label className="inventoryForm__label">Warehouse</label>
                                <select type="text" name="warehouse" placeholder="" value={inventoryData.warehouse_name} onChange={handleInputChange} className="inventoryForm__input" >
                                    <option value=""></option>
                                </select>
                            </form>
                        </div>
